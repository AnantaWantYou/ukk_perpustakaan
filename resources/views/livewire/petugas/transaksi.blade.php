<div class="row">
    <div class="col-12">
      ...
      <div class="btn-group mb-3 ">
        <button wire:click="format" class="btn btn-sm bg-teal mr-3">Semua</button>
        <button wire:click="belumDipinjam" class="btn btn-sm bg-indigo mr-3">Belum Dipinjam</button>
        <button wire:click="sedangDipinjam" class="btn btn-sm bg-olive mr-3">Sedang Dipinjam</button>
        <button wire:click="selesaiDipinjam" class="btn btn-sm bg-fuchsia mr-3">Selesai Dipinjam</button>
      </div>
      ...
      <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('pdf.transaksi') }}">
                <span class="btn btn-sm btn-danger">Cetak PDF</</span>
              </a>
