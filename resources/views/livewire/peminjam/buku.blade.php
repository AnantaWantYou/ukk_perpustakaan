    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="input-group mb-2">
                <input wire:model.live.throttle.500ms="Search" type="text" class="form-control" id="inlineFormInputGroup" placeholder="Cari Buku">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <button wire:click="keranjang({{$buku->id}})" class="btn btn-success">Keranjang</button>
                    ...
                    {{-- <button class="btn btn-success" wire:click="create">Buat Ulasan</button> --}}

                    <!-- Modal untuk membuat ulasan -->
